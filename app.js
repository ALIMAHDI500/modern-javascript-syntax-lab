...
console.log("First : "+firstIngredient+"\n"+"second: "+secondIngredient);
...
const userProfile={[propertyName]:"Ali",
...
function addTwoVarible(noun='cat',adjective='orange.'){

    return `The ${noun} is ${adjective}`

}
console.log(addTwoVarible());
...
const localLangConfig = null //can be 'es' 'fr' 'Ar'// Change to 'es', 'fr', etc., or leave it `null`.
